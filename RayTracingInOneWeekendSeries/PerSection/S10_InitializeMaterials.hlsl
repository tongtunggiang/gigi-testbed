...
/*$(_compute:MainCS)*/(uint3 DTid : SV_DispatchThreadID)
{
	...
	Materials[2].type = MaterialType::Metal;
	Materials[2].color = float3(0.8f, 0.8f, 0.8f);
	Materials[2].fuzz = 0.3f;
	// auto material_right  = make_shared<metal>(color(0.8, 0.6, 0.2));
	Materials[3].type = MaterialType::Metal;
	Materials[3].color = float3(0.8f, 0.6f, 0.2f);
	Materials[3].fuzz = 1.0f;
}
